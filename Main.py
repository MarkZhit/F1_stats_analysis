...
def get_table_from_wiki(url: str, table_caption: str) -> NDArray:
...
""" Code """
F1_seasons_table: NDArray = get_table_from_wiki("https://en.wikipedia.org/wiki/List_of_Formula_One_World_Drivers%27_Champions", "World Drivers' Champions by season")
